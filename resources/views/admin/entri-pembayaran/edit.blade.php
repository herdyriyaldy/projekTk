...
@section('title', 'Edit Entri Pembayaran')
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('entri-pembayaran.update',$edit->id) }}">
                        @csrf
                        @method('put')

                        <div class="form-group">
                            <label>NIS Siswa</label>
                            <input type="text" class="form-control @error('nis') is-invalid @enderror" name="nis" value="{{ $edit->siswa->nis }}">
                        ...
                        <a href="{{ route('entri-pembayaran.index') }}" class="btn btn-primary btn-rounded">
